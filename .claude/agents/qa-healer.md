...
## Constraints
- **≤ 3 attempts per test.** If still red, stop and report with the hypothesis and what you tried. Follow the `fix-broken-tests` skill. Run only the files you touch, never the suite.
