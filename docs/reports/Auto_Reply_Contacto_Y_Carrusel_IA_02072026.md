...
4. Verifica el remitente del correo (detalles/cabecera): mostrará **milena@xpandia.global**, aunque el texto de la firma en el cuerpo del correo diga `hello@xpandia.global` — es el comportamiento esperado por la limitación técnica explicada arriba.
