    ...
    <>
          ...
          <nav className="hidden tablet:flex items-center gap-7" aria-label="Primary">
            <div className="relative group">
              ...
              >
                ...
                {[
                  { href: '/services/language-assurance', num: '01 / VALIDATE', label: 'Language Assurance', desc: 'Validate Spanish before your users do.' },
                  { href: '/services/localization-adaptation', num: '02 / ADAPT', label: 'Localization & Adaptation', desc: 'More than translated. Built for Spanish-speaking audiences.' },
                  { href: '/services/applied-cultural-intelligence', num: '03 / UNDERSTAND', label: 'Applied Cultural Intelligence', desc: 'Read the invisible rules behind trust, culture, and growth.' },
                ].map(item => (
            ...
            <Link className={cn(linkBase, activePage === 'contact' && linkActive)} href="/contact">Contact</Link>
          </nav>
      ...
      >
        ...
        {[
          ...
          { href: '/services/language-assurance', num: '01 / VALIDATE', label: 'Language Assurance' },
          { href: '/services/localization-adaptation', num: '02 / ADAPT', label: 'Localization & Adaptation' },
          { href: '/services/applied-cultural-intelligence', num: '03 / UNDERSTAND', label: 'Applied Cultural Intelligence' },
        ].map(item => (
        ...
        <Link href="/contact" className="block py-[18px] border-b border-ink-150 font-display text-[22px] text-ink-900" onClick={closeDrawer}>Contact</Link>
