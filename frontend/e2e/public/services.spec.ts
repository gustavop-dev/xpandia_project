...
test.describe('Services', () => {
  ...
  test('Language Assurance service page loads', async ({ page }) => {
  ...
  test('Spanish Experience Repair & Adaptation service page loads', async ({ page }) => {
  ...
  test('Applied Cultural Intelligence service page loads', async ({ page }) => {
  ...
  test('legacy /services/qa redirects to Language Assurance', async ({ page }) => {
