---
description: "Detiene los dev servers locales (backend runserver + frontend dev) levantados por dev-up, por PID file con fallback por puerto. Solo dev machine."
