...
description: "Sync current branch (default: vps-ops-toolkit; pass --all to iterate over LOCAL_PROJECTS + toolkit on this host)"
---
...
`VALID_REPOS`. Antes de cada iteración:
```bash
