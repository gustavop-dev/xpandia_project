...
description: Playwright end-to-end testing best practices and automation patterns. Use when writing browser automation tests, implementing test suites, or working with Playwright fixtures and assertions.
---
